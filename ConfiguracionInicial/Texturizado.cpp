...
int main()
{
	...
	// Ejercicio 1. Cuadricula inferior derecha
	//GLfloat vertices[] =
	//{
	//	// Positions            // Colors              // Texture Coords
	...
	// Ejercicio 2. Cuadricula superior izquierda
	//GLfloat vertices[] =
	//{
	//	// Positions            // Colors              // Texture Coords
	...
	// Ejercicio 3. Cuadricula central
	//GLfloat vertices[] =
	//{
	//	// Positions            // Colors              // Texture Coords
	...
	// Ejercicio 4. Ventana en mosaico
	GLfloat vertices[] =
	{
		// Positions            // Colors              // Texture Coords
		-0.5f, -0.5f, 0.0f,    1.0f, 1.0f,1.0f,		0.0f,0.0f,
		0.5f, -0.5f, 0.0f,	   1.0f, 1.0f,1.0f,		3.5f,0.0f,
		0.5f,  0.5f, 0.0f,     1.0f, 1.0f,1.0f,	    3.5f,4.0f,
